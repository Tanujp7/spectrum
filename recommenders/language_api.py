...
class MeaningCloudClassifier:
    ...
    def request(self):
        ...
        payload = 'key=' + os.environ['SPECTRUM_MEANINGCLOUD_SECRET_KEY'] + '&txt=' + str(self.document.description).encode('utf-8') + '&title=' + str(self.document.book.title).encode('utf-8') + '&model=IPTC_en'
