...
class MeaningCloudClassifier:
    ...
    def request(self):
        ...
        payload = 'key='.encode('utf-8') + (os.environ['SPECTRUM_MEANINGCLOUD_SECRET_KEY']).encode('utf-8') + '&txt='.encode('utf-8') + description + '&title='.encode('utf-8') + title + '&model=IPTC_en'.encode('utf-8')
